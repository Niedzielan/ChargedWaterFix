...
namespace ChargedWaterFix
{
  public static class Main
  {
    public static bool Enabled;
    private static readonly LogWrapper Logger = LogWrapper.Get("ChargedWaterFix");
      ...
      static void Init()
      {
        try
        {
          ...
          Logger.Info("Configuring blueprints.");
                    ...
                    ChargedWaterFixBP.ChargedWaterFixBP.Configure();
        }
        catch (Exception e)
        {
